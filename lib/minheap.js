  ...
  heapDown(index) {
    ...
    if (leftChild < this.store.length ) {
      if (rightChild < this.store.length){
        if (this.store[leftChild].key < this.store[rightChild].key) {
      ...
      if (this.store[index].key > this.store[currentChild].key){
        this.swap(index, currentChild);
        this.heapDown(currentChild);
      }
    }

    if (this.store[currentChild].key > this.store[index].key) {
